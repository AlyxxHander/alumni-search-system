    ...
    <div class="bg-white rounded-lg shadow p-4 mb-4">
        <form method="GET" action="{{ route('alumni.index') }}" class="flex flex-wrap gap-3 items-end">
            <div class="flex-1 min-w-[200px]">
                ...
                <input type="text" name="search" value="{{ request('search') }}" placeholder="Nama, NIM, atau Prodi..."
                    ...
                    <tr class="hover:bg-gray-50">
                        ...
                        <td class="px-4 py-3">
                            <div class="flex gap-2 items-center flex-wrap">
                                ...
                                <button type="button" onclick="lacakUlang({{ $a->id }}, this)" class="text-indigo-600 hover:text-indigo-800 font-medium text-xs ml-1 pl-2 border-l">🔍 Lacak Ulang</button>
                            </div>
                        </td>
                    </tr>
                @empty
                    <tr>
                        <td colspan="6" class="px-4 py-8 text-center text-gray-500">Belum ada data alumni.</td>
                    </tr>
                @endforelse
            </tbody>
        </table>
